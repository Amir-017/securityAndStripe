...
export const Login = () => {
    ...
    return (
        <div className="relative w-screen min-h-screen bg-slate-950 flex items-center justify-center px-4 py-8 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md bg-slate-900/95 backdrop-blur-sm border border-slate-800 shadow-2xl shadow-black/40 rounded-2xl p-6 sm:p-8">
                {/* Corner Rivets */}
